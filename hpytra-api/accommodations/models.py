...
class Place(models.Model):
    ...
    map_center_lat = models.DecimalField(max_digits=9, decimal_places=6, blank=True, null=True)
    map_center_lng = models.DecimalField(max_digits=9, decimal_places=6, blank=True, null=True)
    map_zoom = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
